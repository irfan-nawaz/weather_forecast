...
const Hero = ({ handleLogout }) => {
  return (
    <section className="hero">
      {/* <nav>
        <h2><a hatherapplicationse.netlify.app/" style={{color: "White", textDecoration: "none"}}>Home</a></h2>
        <h2><a href="https://oref="https://wepenweathermap-cyan.vercel.app/" style={{color: "White", textDecoration: "none"}}>Weather maps</a></h2>
