(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ionic/core'), require('@ionic/angular'), require('ngx-webstorage'), require('rxjs'), require('rxjs/operators'), require('imask'), require('@angular/router'), require('faunadb'), require('@angular/platform-browser'), require('@capacitor/core'), require('@byteowls/capacitor-oauth2'), require('firebase/app'), require('@angular/fire'), require('@angular/fire/firebase.app.module'), require('@angular/fire/auth'), require('@angular/fire/database'), require('@angular/fire/storage'), require('@angular/fire/firestore'), require('@angular/fire/messaging'), require('ts-md5'), require('@angular/common'), require('ngx-pipes')) :
    typeof define === 'function' && define.amd ? define('ao-angular', ['exports', '@angular/core', '@ionic/core', '@ionic/angular', 'ngx-webstorage', 'rxjs', 'rxjs/operators', 'imask', '@angular/router', 'faunadb', '@angular/platform-browser', '@capacitor/core', '@byteowls/capacitor-oauth2', 'firebase/app', '@angular/fire', '@angular/fire/firebase.app.module', '@angular/fire/auth', '@angular/fire/database', '@angular/fire/storage', '@angular/fire/firestore', '@angular/fire/messaging', 'ts-md5', '@angular/common', 'ngx-pipes'], factory) :
    (global = global || self, factory(global['ao-angular'] = {}, global.ng.core, global['@ionic/core'], global['@ionic/angular'], global['ngx-webstorage'], global.rxjs, global.rxjs.operators, global.imask, global.ng.router, global.faunadb, global.ng.platformBrowser, global['@capacitor/core'], global['@byteowls/capacitor-oauth2'], global['firebase/app'], global.ng.fire, global.ng.fire.firebase.app.module, global.ng.fire.auth, global.ng.fire.database, global.ng.fire.storage, global.ng.fire.firestore, global.ng.fire.messaging, global['ts-md5'], global.ng.common, global['ngx-pipes']));
}(this, (function (exports, core, core$1, angular, ngxWebstorage, rxjs, operators, IMask, router, faunadb, platformBrowser, core$2, capacitorOauth2, app, fire, firebase_app_module, auth, database, storage, firestore, messaging, tsMd5, common, ngxPipes) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AOContainerComponent = /** @class */ (function () {
        ...
        function () {
            /** @type {?} */
            var animation = core$1.createAnimation()
        ...
        AOContainerComponent.propDecorators = {
            directive: [{ type: core.Input }],
            tref: [{ type: core.ViewChild, args: ["tref", { read: core.ElementRef, static: true },] }]
        };
    ...
    var AOContainerService = /** @class */ (function () {
        ...
        /** @nocollapse */ AOContainerService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOContainerService_Factory() { return new AOContainerService(); }, token: AOContainerService, providedIn: "root" });
    ...
    var AOMenuService = /** @class */ (function () {
        ...
        AOMenuService.ctorParameters = function () { return [
            ...
            { type: angular.MenuController }
        ]; };
        /** @nocollapse */ AOMenuService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOMenuService_Factory() { return new AOMenuService(core.ɵɵinject(angular.Platform), core.ɵɵinject(angular.MenuController)); }, token: AOMenuService, providedIn: "root" });
    ...
    var AOService = /** @class */ (function () {
        ...
        /** @nocollapse */ AOService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOService_Factory() { return new AOService(core.ɵɵinject(angular.Platform), core.ɵɵinject(angular.LoadingController), core.ɵɵinject(angular.AlertController), core.ɵɵinject(angular.ModalController), core.ɵɵinject(angular.ActionSheetController), core.ɵɵinject(angular.ToastController), core.ɵɵinject(AOMenuService), core.ɵɵinject(AOContainerService)); }, token: AOService, providedIn: "root" });
        return AOService;
    }());
    if (false) {
        /** @type {?} */
    ...
    var AOAuthService = /** @class */ (function () {
        ...
        function AOAuthService(_nav, _ao) {
            ...
            AOAuthService._onChange = new rxjs.BehaviorSubject(this.user());
        }
        // -------------------------------------------------------------------------------------------------------------------
        // -------------------------------------------------------------------------------------------------------------------
        /**
        ...
        AOAuthService._onLogin = new core.EventEmitter();
        AOAuthService._onLogout = new core.EventEmitter();
        ...
        /** @nocollapse */ AOAuthService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOAuthService_Factory() { return new AOAuthService(core.ɵɵinject(angular.NavController), core.ɵɵinject(AOService)); }, token: AOAuthService, providedIn: "root" });
        __decorate([
            ngxWebstorage.LocalStorage('user'),
            __metadata("design:type", Object)
        ], AOAuthService.prototype, "_user", void 0);
        __decorate([
            ngxWebstorage.LocalStorage('redirect'),
    ...
    var AOMaskDirective = /** @class */ (function () {
        ...
        AOMaskDirective.decorators = [
            { type: core.Directive, args: [{
                        selector: '[ao-mask]',
                        providers: [angular.IonInput],
                    },] }
        ];
        /** @nocollapse */
        AOMaskDirective.ctorParameters = function () { return [
            { type: angular.IonInput }
        ]; };
        AOMaskDirective.propDecorators = {
            mask: [{ type: core.Input, args: ['ao-mask',] }],
            min: [{ type: core.Input, args: ['ao-min',] }],
            max: [{ type: core.Input, args: ['ao-max',] }]
        };
    ...
    var AOGuestGuard = /** @class */ (function () {
        ...
        function (route, state) {
             ...
             */
            function (event) {
                if (event instanceof router.NavigationEnd && event.url !== state.url) {
                    _this._subscriptions.stop();
                }
            })));
            return true;
    ...
    var AOFaunaDBPaginationHelper = /** @class */ (function () {
        ...
        function () {
            ...
            this._search = this._query(faunadb.query, __assign({}, this.filters()));
            return this.first();
        };
        /**
         * @return {?}
    ...
    var AONl2BrPipe = /** @class */ (function () {
        ...
        function (value, sanitizeBeforehand) {
            ...
            if (!core.VERSION || core.VERSION.major === '2') {
                ...
                return this._sanitizer.sanitize(core.SecurityContext.HTML, parsed);
            }
            return parsed;
        };
    ...
    var AOFirebaseConnectionService = /** @class */ (function () {
        ...
        function () {
            return this._auth
                ? this._auth
                : this._auth = new auth.AngularFireAuth(this._configs, this._name, null, this._zone);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            return this._database
                ? this._database
                : this._database = new database.AngularFireDatabase(this._configs, this._name, null, null, this._zone);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            return this._firestore
                ? this._firestore
                : this._firestore = new firestore.AngularFirestore(this._configs, this._name, null, null, null, this._zone, null);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            return this._messaging
                ? this._messaging
                : this._messaging = new messaging.AngularFireMessaging(this._configs, this._name, null, this._zone);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            return this._storage
                ? this._storage
                : this._storage = new storage.AngularFireStorage(this._configs, this._name, null, null, this._zone);
        };
        // -------------------------------------------------------------------------------------------------------------------
        // -------------------------------------------------------------------------------------------------------------------
        /**
     ...
     */
    /** @type {?} */
    var AOEnvService = new core.InjectionToken('AOModuleEnvInterface');
    ...
    var AOFirebaseFactoryService = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            if (!app) {
                                app = firebase_app_module._firebaseAppFactory((/** @type {?} */ (configs)), this._zone, name);
                            }
        ...
        AOFirebaseFactoryService.ctorParameters = function () { return [
            ...
            { type: core.NgZone },
            { type: undefined, decorators: [{ type: core.Inject, args: [AOEnvService,] }] }
        ]; };
        /** @nocollapse */ AOFirebaseFactoryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOFirebaseFactoryService_Factory() { return new AOFirebaseFactoryService(core.ɵɵinject(fire.FirebaseApp), core.ɵɵinject(core.NgZone), core.ɵɵinject(AOEnvService)); }, token: AOFirebaseFactoryService, providedIn: "root" });
    ...
    var AOFirebaseService = /** @class */ (function () {
         ...
         */
        function () {
            return app.firestore.Timestamp;
        };
        ...
        /** @nocollapse */ AOFirebaseService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOFirebaseService_Factory() { return new AOFirebaseService(core.ɵɵinject(AOFirebaseFactoryService)); }, token: AOFirebaseService, providedIn: "root" });
    ...
    var AOAuthFirebaseService = /** @class */ (function () {
        function AOAuthFirebaseService(_auth, _fb, _env) {
            ...
            this._env = _env;
            this._subscriptions = new AOSubscriptions();
            core$2.registerWebPlugin(capacitorOauth2.OAuth2Client);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            oauth = null;
                            credential = null;
                            if (!(data.provider instanceof app.auth.GoogleAuthProvider)) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.loginGoogle()];
                        case 1:
                            oauth = _a.sent();
                            credential = app.auth.GoogleAuthProvider.credential(null, oauth.access_token);
                            return [3 /*break*/, 9];
                        case 2:
                            if (!(data.provider instanceof app.auth.FacebookAuthProvider)) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.loginFacebook()];
                        case 3:
                            oauth = _a.sent();
                            credential = app.auth.FacebookAuthProvider.credential(oauth.access_token);
                            return [3 /*break*/, 9];
                        case 4:
                            if (!(data.provider instanceof app.auth.TwitterAuthProvider)) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.loginTwitter()];
                        case 5:
                            oauth = _a.sent();
                            credential = app.auth.TwitterAuthProvider.credential(oauth.access_token, '');
                            return [3 /*break*/, 9];
                        case 6:
                            if (!(data.provider instanceof app.auth.GithubAuthProvider)) return [3 /*break*/, 8];
                            return [4 /*yield*/, this.loginGithub()];
                        case 7:
                            oauth = _a.sent();
                            credential = app.auth.GithubAuthProvider.credential(oauth.access_token);
                            return [3 /*break*/, 9];
                        case 8:
         ...
         */
        function () {
            return core$2.Plugins.OAuth2Client.authenticate({
                scope: 'email profile',
        ...
        /** @nocollapse */ AOAuthFirebaseService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOAuthFirebaseService_Factory() { return new AOAuthFirebaseService(core.ɵɵinject(AOAuthService), core.ɵɵinject(AOFirebaseService), core.ɵɵinject(AOEnvService)); }, token: AOAuthFirebaseService, providedIn: "root" });
    ...
    var AOAuthOauthService = /** @class */ (function () {
        ...
        /** @nocollapse */ AOAuthOauthService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOAuthOauthService_Factory() { return new AOAuthOauthService(); }, token: AOAuthOauthService, providedIn: "root" });
    ...
    var AOFaunaDbService = /** @class */ (function () {
        ...
        function AOFaunaDbService(_ao, _storage, _environment) {
            ...
            this._environment = _environment;
            this.q = _q;
            this._observer = new core.EventEmitter();
        ...
        /** @nocollapse */ AOFaunaDbService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOFaunaDbService_Factory() { return new AOFaunaDbService(core.ɵɵinject(AOService), core.ɵɵinject(ngxWebstorage.LocalStorageService), core.ɵɵinject(AOEnvService)); }, token: AOFaunaDbService, providedIn: "root" });
    ...
    var AOFirebaseSlaveService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ AOFirebaseSlaveService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AOFirebaseSlaveService_Factory() { return new AOFirebaseSlaveService(core.ɵɵinject(AOFirebaseFactoryService)); }, token: AOFirebaseSlaveService, providedIn: "root" });
        ...
        AOModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            messaging.AngularFireMessagingModule,
                        ],
                        exports: [
                            //
                            // MODULES
                            ...
                            ngxPipes.PluckPipe,
                            common.DatePipe,
                            ngxPipes.OrderByPipe,
                            ngxPipes.ReversePipe,
                            ngxPipes.SumPipe,
                            ngxPipes.FilterByPipe,
                            ngxPipes.GroupByPipe,
                        ],
                        declarations: [
                            //
                            // COMPONENTS
    ...
    exports.AOAppComponent = AOAppComponent;
    exports.AOArray = AOArray;
    exports.AOAuthFirebaseService = AOAuthFirebaseService;
    exports.AOAuthOauthService = AOAuthOauthService;
    exports.AOAuthService = AOAuthService;
    exports.AOCacheService = AOCacheService;
    exports.AOContainerComponent = AOContainerComponent;
    exports.AOContainerDirective = AOContainerDirective;
    exports.AOContainerService = AOContainerService;
    exports.AOEnvService = AOEnvService;
    exports.AOFake = AOFake;
    exports.AOFaunaDBPaginationHelper = AOFaunaDBPaginationHelper;
    exports.AOFaunaDbService = AOFaunaDbService;
    exports.AOFirebaseConnectionService = AOFirebaseConnectionService;
    exports.AOFirebaseFactoryService = AOFirebaseFactoryService;
    exports.AOFirebaseService = AOFirebaseService;
    exports.AOFirebaseSlaveService = AOFirebaseSlaveService;
    exports.AOGuestGuard = AOGuestGuard;
    exports.AOIsGuestDirective = AOIsGuestDirective;
    exports.AOIsUserDirective = AOIsUserDirective;
    exports.AOMaskDirective = AOMaskDirective;
    exports.AOMenuComponent = AOMenuComponent;
    exports.AOMenuService = AOMenuService;
    exports.AOModule = AOModule;
    exports.AONl2BrPipe = AONl2BrPipe;
    exports.AONodeItem = AONodeItem;
    exports.AOService = AOService;
    exports.AOStopPropagationDirective = AOStopPropagationDirective;
    exports.AOString = AOString;
    exports.AOSubscriptions = AOSubscriptions;
    exports.AOTreeHelper = AOTreeHelper;
    exports.AOUserGuard = AOUserGuard;
    exports.AOValidations = AOValidations;
    exports.AOValidators = AOValidators;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ao-angular.umd.js.map
